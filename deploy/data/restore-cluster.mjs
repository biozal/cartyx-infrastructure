...
try {
  ...
  const keys = ['tls.p12', 'tls.crt', 'tls-password', 'gremlin-password', 'gremlin-app-password', 'cassandra-admin-password', 'cassandra-graph-password', 'cassandra-state-password'];
